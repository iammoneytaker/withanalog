  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="relative mb-6">
        <div className="text-xl leading-8 p-6 bg-gray-800 rounded-lg font-mono break-all">
      ...
      {isCompleted && (
        ...
        >
          <h3 className="text-2xl font-bold text-green-400 mb-4">완료!</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-gray-400">정확한 글자</div>
            </div>
            <div>
